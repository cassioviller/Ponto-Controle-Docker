...
-- Estagiários: intervalo registrado mas não descontado do tempo trabalhado.
ALTER TABLE funcionarios ADD COLUMN IF NOT EXISTS intervalo_nao_descontado BOOLEAN NOT NULL DEFAULT FALSE;
